...
def market_create_session(subsession):
    ...
    if num_traders % 2 != 0:
        raise Exception("Need a multiple of 2 traders")

    if num_traders < 16:
        traders_per_market = int(num_traders / 2)
    elif num_traders % 24 == 0:
        traders_per_market = 8
    elif num_traders % 22 == 0:
        traders_per_market = 11
    elif num_traders % 20 == 0:
        traders_per_market = 10
    elif num_traders % 18 == 0:
        traders_per_market = 9    
    ...
    for group in subsession.get_groups():
        ...
        # set cash and assets
        # random sequence
        if num_traders/2 % 2 != 0:
            high_cash = [True for i in range(int(traders_per_market / 2)+1)] + [False for i in range(int(traders_per_market / 2))]
        else:
